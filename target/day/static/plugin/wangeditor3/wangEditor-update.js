...
this.editor = editor;
//this.$elem = $('<div class="w-e-menu" style="padding-top:4px;"><span class="w-e-menu-item" style="font-size:16px;font-weight:600;">F</span></div>');
...
this.droplist = new DropList(this, {
    ...
    type: 'inline-block', // droplist 内容以 block 形式展示
    list: [
           { $elem: $('<font class="w-e-menu-item-value" face="Microsoft YaHei">微软雅黑</font>'), value: 'Microsoft YaHei' },
           { $elem: $('<font class="w-e-menu-item-value" face="Microsoft JhengHei;">微软正黑体</font>'), value: 'Microsoft JhengHei'},
           { $elem: $('<font class="w-e-menu-item-value" face="KaiTi_GB2312;">楷体_GB2312</font>'), value: 'KaiTi_GB2312'},
           { $elem: $('<font class="w-e-menu-item-value" face="FangSong_GB2312;">仿宋_GB2312</font>'), value: 'FangSong_GB2312'},
           { $elem: $('<font class="w-e-menu-item-value" face="KaiTi;">楷体&emsp;&emsp;</font>'), value: 'KaiTi'},
           { $elem: $('<font class="w-e-menu-item-value" font="FangSong;">仿宋&emsp;&emsp;</font>'), value: 'FangSong'},
           { $elem: $('<font class="w-e-menu-item-value" face="NSimSun">新宋体</font>'), value: 'NSimSun'},
           { $elem: $('<font class="w-e-menu-item-value" face="SimSun;">宋体&emsp;&emsp;</font>'), value: 'SimSun'},
           { $elem: $('<font class="w-e-menu-item-value" face="SimHei;">黑体&emsp;&emsp;</font>'), value: 'SimHei'},
           { $elem: $('<font class="w-e-menu-item-value" face="DFKai-SB;">标楷体&emsp;</font>'), value: 'DFKai-SB'},
           { $elem: $('<font class="w-e-menu-item-value" face="MingLiU;">细明体&emsp;</font>'), value: 'MingLiU'},
           { $elem: $('<font class="w-e-menu-item-value" face="PMingLiU;">新细明体</font>'), value: 'PMingLiU'},
           ],
    onClick: function onClick(value) {
        // 注意 this 是指向当前的 fontFamily对象
        _this._command(value);
    }
});
}
...
this.droplist = new DropList(this, {
    ...
    type: 'inline-block', // droplist 内容以 block 形式展示
    list: [
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:12px;">12px&emsp;&emsp;</span>'), value: 1},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:13px;">13px&emsp;&emsp;</span>'), value: 2},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:16px;">16px&emsp;&emsp;</span>'), value: 3},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:18px;">18px&emsp;&emsp;</span>'), value: 4},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:24px;">24px</span>'), value: 5},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:32px;">32px</span>'), value: 6},
           { $elem: $('<span class="w-e-menu-item-value" style="font-size:48px;">48px</span>'), value: 7},
           ],
    onClick: function onClick(value) {
        // 注意 this 是指向当前的 fontFamily对象
        _this._command(value);
...
this.editor = editor;
this.$elem = $('<div class="w-e-menu"><i class="w-e-icon-text-height"><i/></div>');
this.type = 'droplist';
...
this.droplist = new DropList(this, {
    ...
    type: 'inline-block', // droplist 内容以 block 形式展示
    list: [
           { $elem: $('<span class="w-e-menu-item-value">1.0倍</span>'), value: 1.0},
           { $elem: $('<span class="w-e-menu-item-value">1.5倍</span>'), value: 1.5},
           { $elem: $('<span class="w-e-menu-item-value">1.8倍</span>'), value: 1.8},
           { $elem: $('<span class="w-e-menu-item-value">2.0倍</span>'), value: 2.0},
           { $elem: $('<span class="w-e-menu-item-value">2.5倍</span>'), value: 2.5},
           { $elem: $('<span class="w-e-menu-item-value">3.0倍</span>'), value: 3.0},
           ],
    onClick: function onClick(value) {
        // 注意 this 是指向当前的 fontFamily对象
        _this._command(value);
...
_command: function _command(value) {
    var editor = this.editor;
    var api = new API(editor);
    var range = editor.selection.getRange()
    var targetElem = api.getSelectionContainerElem(range)
    if (!targetElem) {
        return;
    }
